# Source: https://github.com/JPM-Tech/Object-Detection/blob/main/Scripts/converters/convert-yolo-to-xml.py
# Note: Slightly modified do accept relative paths
#
...
def yolo_to_xml(input_folder, classes_file):
    
    folder_holding_yolo_files = os.path.abspath(os.path.join(os.path.dirname(__file__), input_folder))
    yolo_class_list_file = os.path.abspath(os.path.join(os.path.dirname(__file__), classes_file))
...
if __name__ == "__main__":
    ...
    yolo_to_xml("./Data\Drone", "./Data\Drone/classes.txt")
